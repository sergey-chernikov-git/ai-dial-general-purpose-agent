...
class FileContentExtractionTool(BaseTool):
    ...
    def description(self) -> str:
        return (
            ...
            "RESPONSE FORM: `**Page #X. Total pages: Y**` appears at end if paginated. "
            "USAGE: Start with page=1. If paginated, then call again with page=2, page=3"
            "Check response end for pagination info before answering user queries about file content."
        )

    @property
    def parameters(self) -> dict[str, Any]:
        return FileContentExtractionToolType.schema()
